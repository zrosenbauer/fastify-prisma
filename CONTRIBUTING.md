...
1. When you make a user-visible change, run `pnpm changeset` and follow the prompts to write a changeset file describing the bump (`patch` / `minor` / `major`) and the change.
