 ...
 */
export default fp(
  async (fastify: FastifyInstance, opts: fastifyPrisma.FastifyPrismaOptions): Promise<void> => {
    if (!opts.client) {
...
// oxlint-disable-next-line no-explicit-any -- Prisma client is generated by Prisma at consumer-time
type AllowedAny = any;
